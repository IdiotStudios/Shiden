...
- Context-aware completions (locals, params, file-level functions, builtins and keywords). Completions also include **workspace-level function names** discovered by scanning `*.sd` files across the workspace.
