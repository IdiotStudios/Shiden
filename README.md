...
The repo is being refactored so you can view the rust source code in `archived/rust_backup`. and the you can run it by downloading the relevant files for your OS from gh releases v0.1.2. The exe/binary are cli tools not GUI tools
