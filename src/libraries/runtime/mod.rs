...
pub fn get_helpers(target: &str) -> BTreeMap<&'static str, Vec<u8>> {
    if target.contains("windows") {
        ...
        m.insert(
            "__build_args_array",
            vec![
                0x48, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x49, 0x89, 0xC6,
                0x48, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x49, 0x89, 0xC7,
                0x55, 0x48, 0x89, 0xe5, 0x53, 0x41, 0x54, 0x41, 0x55, 0x48, 0x83, 0xEC, 0x08,
                0x48, 0xB8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xD0, 0x49,
                0x89, 0xC4, 0x45, 0x31, 0xED, 0x4D, 0x39, 0xF5, 0x7D, 0x2D, 0x4B, 0x8B, 0x0C,
                0xEF, 0x48, 0x89, 0xCF, 0x48, 0xB8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                0x00, 0xFF, 0xD0, 0x4C, 0x89, 0xE7, 0x48, 0x89, 0xC6, 0x48, 0xB8, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xD0, 0x49, 0xFF, 0xC5, 0xE9, 0xCE,
                0xFF, 0xFF, 0xFF, 0x4C, 0x89, 0xE0, 0x48, 0x83, 0xC4, 0x08, 0x41, 0x5D, 0x41,
                0x5C, 0x5B, 0x5D, 0xC3,
            ],
        );
